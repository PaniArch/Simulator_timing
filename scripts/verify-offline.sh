...
# timing/runner's full cold-cache suite can legitimately exceed Go's default
# 10-minute per-package timeout on shared hosts. Keep a finite guard without
# turning normal host-speed variance into a false validation failure.
